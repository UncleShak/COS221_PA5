...
-- ============================================================
-- 2. USERS (needed before Travellers and Agencies)
-- Password for all demo accounts: Password123!
-- Hash: $2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi
-- ============================================================

INSERT IGNORE INTO Users (user_id, email, username, password_hash, user_type, created_at, is_active) VALUES
-- Existing travellers from dump (1, 2) and agencies (3, 4) skipped via INSERT IGNORE
-- New travellers
...
-- ============================================================
-- 5. DESTINATIONS (depends on Locations)
-- ============================================================
...
-- ============================================================
-- 6. FLIGHTS (depends on Locations)
-- ============================================================
...
-- ============================================================
-- 7. ACCOMMODATIONS (depends on Locations)
-- ============================================================
...
-- ============================================================
-- 8. ACCOMMODATION AMENITIES (depends on Accommodations)
-- ============================================================
...
-- ============================================================
-- 9. ATTRACTIONS (depends on Locations)
-- ============================================================
...
-- ============================================================
-- 10. RESTAURANTS (depends on Locations)
-- ============================================================
...
-- ============================================================
-- 11. PACKAGES (depends on Agencies)
-- Your dump already has packages 1, 2, 3 — these add more
-- ============================================================
...
-- ============================================================
-- 12. GROUP TRIPS (depends on Packages)
-- ============================================================
...
-- ============================================================
-- 13. PACKAGE DESTINATIONS (depends on Packages + Destinations)
-- ============================================================

INSERT IGNORE INTO PackageDestinations (package_id, destination_id, day_number, visit_order) VALUES
-- Package 1: Paris Escape
(1, 1,  1, 1),
-- Package 2: Tokyo Explorer
(2, 3,  1, 1),
-- Package 3: Cape Town Adventure
(3, 2,  1, 1),
-- Package 4: Maasai Mara Safari
(4, 5,  1, 1),
-- Package 5: Zanzibar
(5, 7,  1, 1),
-- Package 6: Mauritius
...
-- ============================================================
-- 14. PACKAGE FLIGHTS (depends on Packages + Flights)
-- ============================================================

INSERT IGNORE INTO PackageFlights (package_id, flight_id, is_outbound) VALUES
-- Package 1: Paris (JNB-CDG economy, CDG-JNB return)
(1, 1, 1), (1, 2, 0),
-- Package 2: Tokyo (JNB-NRT, NRT-JNB)
(2, 3, 1), (2, 4, 0),
-- Package 3: Cape Town (JNB-CPT, CPT-JNB)
(3, 5, 1), (3, 6, 0),
-- Package 4: Nairobi safari (JNB-NBO, NBO-JNB)
(4, 9, 1), (4, 10, 0),
-- Package 5: Zanzibar (JNB-NBO then DAR-ZNZ)
(5, 9, 1), (5, 13, 1), (5, 10, 0),
-- Package 6: Mauritius (JNB-MRU)
(6, 14, 1),
-- Package 7: Dubai (JNB-DXB, DXB-JNB)
(7, 7, 1), (7, 8, 0),
-- Package 8: New York (JNB-JFK, JFK-JNB)
(8, 11, 1), (8, 12, 0),
-- Package 9: Amsterdam (JNB-AMS)
(9, 15, 1),
-- Package 10: Durban (JNB-DUR, DUR-JNB)
(10, 18, 1), (10, 19, 0),
-- Package 11: Marrakech (JNB-AMS then AMS-CMN rough — using AMS flight as proxy)
(11, 15, 1),
-- Package 12: Lisbon (JNB-LIS)
(12, 20, 1),
-- Package 13: Bangkok (JNB-DXB then DXB-BKK rough — using Dubai flight as proxy)
(13, 7, 1),
-- Package 14: Joburg (no flight — local)
-- Package 15: Sydney (JNB-DXB then DXB-SYD — using Dubai flight as proxy)
(15, 7, 1);

-- ============================================================
-- 15. PACKAGE ACCOMMODATIONS (depends on Packages + Accommodations)
-- ============================================================

INSERT IGNORE INTO PackageAccommodations (package_id, accommodation_id, num_nights, check_in_day) VALUES
(1,  1,  3, 1),   -- Paris Escape → Hotel Le Marais
(2,  3,  5, 1),   -- Tokyo → Shibuya Sky Hotel
(3,  2,  4, 1),   -- Cape Town → Cape Grace
(3,  16, 1, 5),   -- Cape Town extra night → Kempinski Camps Bay
(4,  5,  6, 1),   -- Nairobi → Hemingways
(5,  7,  6, 1),   -- Zanzibar → Zanzibar Beach Resort
(5,  17, 1, 6),   -- Zanzibar upgrade night → Matemwe Lodge
(6,  8,  7, 1),   -- Mauritius → Constance Belle Mare
(6,  18, 1, 7),   -- Mauritius second resort → Dinarobin
(7,  4,  4, 1),   -- Dubai → Burj Al Arab
(7,  20, 1, 5),   -- Dubai budget extra → Rove Downtown
(8,  6,  5, 1),   -- New York → Park Hyatt
(9,  9,  4, 1),   -- Amsterdam → Pulitzer
(10, 13, 3, 1),   -- Durban → Oyster Box
(11, 12, 5, 1),   -- Marrakech → La Mamounia
(12, 14, 4, 1),   -- Lisbon → Bairro Alto Hotel
(13, 10, 5, 1),   -- Bangkok → Mandarin Oriental
(14, 15, 2, 1),   -- Joburg → The Saxon
(15, 11, 6, 1);   -- Sydney → Park Hyatt Sydney

-- ============================================================
-- 16. PACKAGE ATTRACTIONS (depends on Packages + Attractions)
-- ============================================================
...
-- ============================================================
-- 17. PACKAGE RESTAURANTS (depends on Packages + Restaurants)
-- ============================================================
...
-- ============================================================
-- 18. BOOKINGS (depends on Travellers + Packages + GroupTrips)
-- Note: existing booking (booking_id=1) skipped via INSERT IGNORE
-- ============================================================
...
-- ============================================================
-- 19. AGENCY REVIEWS (depends on Travellers + Agencies + Bookings)
-- Only on COMPLETED bookings — booking_id 1 is completed
-- ============================================================
...
-- ============================================================
-- 20. PACKAGE REVIEWS (depends on Travellers + Packages + Bookings)
